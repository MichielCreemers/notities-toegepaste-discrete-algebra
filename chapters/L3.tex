...
\begin{nicetheorem}*[ontbindingsstelling voor afbeeldingen]\label{stelling:H3_ontbindingsstelling}
    \nextpart[]*
...
\begin{nicetheorem}*\label{H2_e_uniek}
...
\resizebox{0.99\textwidth}{!}{%
    \input{figures/L3/homomorfisme.tex}
}
\end{center}
...
\tocdecorline{Hoofdstuk 3 -- Monoïden en Groepen}
...
\begin{itemize}
    ...
    \item $\langle 2^U,\ \cap\rangle$ -- De bewerking is de doorsnede, deze is associatief:
    \begin{equation*}
