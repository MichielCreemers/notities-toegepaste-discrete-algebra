...
\begin{equation*}
    ...
    \end{gathered}
\end{equation*}
Dus $x \in \bar{a}$. Hieruit volgt dan dat: $\quad \bar{b} \subseteq \bar{a}$ (1).
...
\begin{equation*}
    ...
    \end{gathered}
\end{equation*}
Dus $x \in \bar{b}$. Hieruit volgt dat: $\quad \bar{a} \subseteq \bar{b}$ (2).
...
\resizebox{0.5\textwidth}{!}{%
    \input{figures/L3/partitie_disjunct.tex}
}
\end{center}
...
\begin{nicetheorem}*
    \nextpart[]*
    Elke equivalentierelatie "$\sim$" ($R$ in cursus) op $A$ geeft een partitie $P=\{\bar{a}\}$ ($P=\{R_x\}$ in cursus) waarbij $\bar{a} = \{y \in A \mid y \sim a\}$ de \textcolor{red!66!black}{\textbf{equivalentieklass}} van $a$ is. Let op: $\{\bar{a}\}$ is de verzameling van alle equivalentieklassen, en dus een verzameling van deelverzamelingen, wat de partitie is, niet $\bar{a}$!
...
\resizebox{0.55\textwidth}{!}{%
    \input{figures/L3/er_door_f.tex}
}
\end{center}
...
\resizebox{0.75\textwidth}{!}{%
    \input{figures/L3/canonieke_afbeelding.tex}
}
\end{center}
...
\resizebox{0.65\textwidth}{!}{%
    \input{figures/L3/er_en_canoniek.tex}
}
\end{center}
...
\begin{center}
\resizebox{0.65\textwidth}{!}{%
    \input{figures/L3/ontbindingsstelling.tex}
}
\end{center}
...
\resizebox{0.65\textwidth}{!}{%  % Schalen naar de breedte van deze minipage zelf
    \input{figures/L3/hasse_makkelijk.tex}
}
\end{center}
\end{minipage}
...
\resizebox{0.50\textwidth}{!}{%
    \input{figures/L3/hasse_moeilijk.tex}
}
\end{center}
