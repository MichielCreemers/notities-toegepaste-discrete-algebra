...
\node[red!75!black, above right, xshift=4pt] at (\XR,\yR)
    {$R = (a_3,-b_3)$};

\node[red!75!black, right, xshift=4pt] at (\XR,{-\yR})
    {$p_1+p_2 = (a_3, b_3)$};

% --- Opmerking rechts ---
\draw[construction, ->]
    (\XR+1.80,\yR) -- (\XR+1.50,\yR-0.75);
    %(3.0,-0.55) -- (2.25,-1.25);

\node[red!75!black, align=left, below] at (\XR+1.50,\yR-0.80)
    {Let op teken!};
