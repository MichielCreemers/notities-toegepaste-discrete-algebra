...
\tikzset{
    ...
    \node[point, label=left:$1$] (a1) at (0, 2.5) {};
    \node[point, label=left:$2$] (a2) at (0, 1.5) {};
    \node[point, label=left:$3$] (a3) at (0, 0.5) {};
    \node[point, label=left:$4$] (a4) at (0, -0.5) {};

    % Verzameling B
    \path[setB] (5, 1.0) ellipse (1.5cm and 2.2cm);
    \node[labelB] at (6.5, 2.8) {B};
    \node[point, label=right:$a$] (b1) at (5, 2.5) {};
    \node[point, label=right:$b$] (b2) at (5, 1.5) {};
    \node[point, label=right:$c$] (b3) at (5, 0.5) {};

    \draw[arrow] (a1.east) -- (b1.west);
    \draw[arrow] (a2.east) -- (b2.west);
    \draw[arrow] (a3.east) -- (b3.west);
    \draw[arrow] (a4.east) -- (b3.west);
